...
class DoublyLinkedList:
    ...
    def delete(self, node):
        ...
        # otherwise
            ...
            # node.prev=node.next.prev#this closes the gap if removed from the middle. #THIS MESSES UP TESTS FOR LRU
            # node.next=node.prev.next #this closes the gap #THIS MESSES UP TESTS FROM LRU
